 ...
 * 
 */
@WebServiceClient(name = "HumanResourceService", targetNamespace = "http://mycompany.com/hr/definitions", wsdlLocation = "file:/C:/dbus/source/mps-jboss/source/mycode/EJB3WS/src/main/resources/META-INF/wsdl/hr.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/C:/dbus/source/mps-jboss/source/mycode/EJB3WS/src/main/resources/META-INF/wsdl/hr.wsdl");
